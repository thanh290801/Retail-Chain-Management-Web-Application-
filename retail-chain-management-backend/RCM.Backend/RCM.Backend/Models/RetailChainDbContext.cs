...
{
    public partial class RetailChainDbContext : DbContext
    {
        public RetailChainDbContext()
        {
        }

        public RetailChainDbContext(DbContextOptions<RetailChainDbContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-IGHRD48;Database=RetailChain;User Id=sa;Password=123;TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>(entity =>
            {
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .HasConstraintName("FK__Employee__Accoun__19DFD96B");
