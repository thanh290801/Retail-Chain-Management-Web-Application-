...
namespace RCM.Backend.Migrations
{
    ...
    [Migration("20250414162924_ChangeBonusHoursToDecimal")]
    partial class ChangeBonusHoursToDecimal
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountEmployee", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeesEmployeeId" }, "IX_AccountEmployee_EmployeesEmployeeId");

                    b.ToTable("AccountEmployee", (string)null);
                });
            ...
            modelBuilder.Entity("RCM.Backend.Models.AttendanceCheckIn", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_AttendanceCheckIn_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.AttendanceCheckOut", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_AttendanceCheckOut_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.AttendanceRecord", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_AttendanceRecord_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Batch", b =>
                {
                    ...
                    b.Property<decimal?>("BatchPrices")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("batch_prices");

                    b.Property<int?>("PurchaseOrderId")
                        .HasColumnType("int")
                        .HasColumnName("purchase_orderId");
                    ...
                    b.HasIndex(new[] { "WarehouseId" }, "IX_batches_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.BatchDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "BatchId" }, "IX_batch_details_batch_id");

                    b.HasIndex(new[] { "ProductId" }, "IX_batch_details_product_id");

                    b.HasIndex(new[] { "PurchaseOrderId" }, "IX_batch_details_purchase_order_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Cash", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId" }, "IX_CASH_BranchId");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_CASH_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.CashHandover", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId" }, "IX_Cash_Handover_BranchID");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_Cash_Handover_EmployeeID");

                    b.HasIndex(new[] { "ReceiverId" }, "IX_Cash_Handover_ReceiverID");
            ...
            modelBuilder.Entity("RCM.Backend.Models.DailySalesReport", b =>
                {
                    ...
                    b.HasIndex(new[] { "WarehouseId" }, "IX_daily_sales_reports_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.EndShift", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId" }, "IX_End_Shifts_BranchID");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_End_Shifts_EmployeeID");

                    b.ToTable("End_Shifts", (string)null);
                });

            modelBuilder.Entity("RCM.Backend.Models.Notification", b =>
                {
            ...
            modelBuilder.Entity("RCM.Backend.Models.Order", b =>
                {
                    ...
                    b.HasIndex(new[] { "ShopId" }, "IX_Order_shop_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.OvertimeRecord", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_OvertimeRecords_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.PenaltyPayment", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_PenaltyPayments_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.ProductPrice", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_product_prices_product_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.ProductPriceHistory", b =>
                {
                    ...
                    b.HasIndex(new[] { "ChangedBy" }, "IX_product_price_history_changed_by");

                    b.HasIndex(new[] { "ProductId" }, "IX_product_price_history_product_id");

                    b.HasIndex(new[] { "WarehouseId" }, "IX_product_price_history_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Promotion", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_promotions_product_id");

                    b.HasIndex(new[] { "WarehouseId" }, "IX_promotions_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.PurchaseCost", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId" }, "IX_Purchase_Costs_BranchID");

                    b.HasIndex(new[] { "PurchaseOrderId" }, "IX_Purchase_Costs_PurchaseOrderID");
            ...
            modelBuilder.Entity("RCM.Backend.Models.PurchaseOrder", b =>
                {
                    ...
                    b.HasIndex(new[] { "WarehousesId" }, "IX_purchase_orders_WarehousesId");

                    b.HasIndex(new[] { "SupplierId" }, "IX_purchase_orders_supplier_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.PurchaseOrderItem", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_purchase_order_items_product_id");

                    b.HasIndex(new[] { "PurchaseOrderId" }, "IX_purchase_order_items_purchase_order_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Refund", b =>
                {
                    ...
                    b.HasIndex(new[] { "Employeeid" }, "IX_Refund_employeeid");

                    b.HasIndex(new[] { "OrderId" }, "IX_Refund_order_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.RefundDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "RefundId" }, "IX_RefundDetail_refund_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Salary", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_Salary_EmployeeId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.SalaryPaymentHistory", b =>
                {
                    ...
                    b.HasIndex(new[] { "EmployeeId" }, "IX_SalaryPaymentHistory_EmployeeId");

                    b.HasIndex(new[] { "SalaryId" }, "IX_SalaryPaymentHistory_SalaryId");
            ...
            modelBuilder.Entity("RCM.Backend.Models.ShiftSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RCM.Backend.Models.StockAdjustment", b =>
                {
                    ...
                    b.HasIndex(new[] { "AuditorId" }, "IX_stock_adjustments_auditor_id");

                    b.HasIndex(new[] { "WarehouseId" }, "IX_stock_adjustments_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.StockAdjustmentDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "AdjustmentId" }, "IX_stock_adjustment_details_adjustment_id");

                    b.HasIndex(new[] { "ProductId" }, "IX_stock_adjustment_details_product_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.StockAuditDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "AuditId" }, "IX_stock_audit_details_audit_id");

                    b.HasIndex(new[] { "ProductId" }, "IX_stock_audit_details_product_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.StockAuditRecord", b =>
                {
                    ...
                    b.HasIndex(new[] { "AuditorId" }, "IX_stock_audit_records_auditor_id");

                    b.HasIndex(new[] { "CoAuditorId" }, "IX_stock_audit_records_co_auditor_id");

                    b.HasIndex(new[] { "WarehouseId" }, "IX_stock_audit_records_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.StockLevel", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_stock_levels_product_id");

                    b.HasIndex(new[] { "WarehouseId" }, "IX_stock_levels_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.SupplierProduct", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_supplier_products_product_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Transaction", b =>
                {
                    ...
                    b.HasIndex(new[] { "BranchId" }, "IX_Transactions_branch_id");

                    b.HasIndex(new[] { "EmployeeId" }, "IX_Transactions_employee_id");

                    b.HasIndex(new[] { "HandoverId" }, "IX_Transactions_handover_id");

                    b.HasIndex(new[] { "OrderId" }, "IX_Transactions_order_id");

                    b.HasIndex(new[] { "RefundId" }, "IX_Transactions_refund_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.WarehouseTransfer", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedBy" }, "IX_warehouse_transfers_created_by");

                    b.HasIndex(new[] { "FromWarehouseId" }, "IX_warehouse_transfers_from_warehouse_id");

                    b.HasIndex(new[] { "ToWarehouseId" }, "IX_warehouse_transfers_to_warehouse_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.WarehouseTransferDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_warehouse_transfer_details_product_id");

                    b.HasIndex(new[] { "TransferId" }, "IX_warehouse_transfer_details_transfer_id");
            ...
            modelBuilder.Entity("RCM.Backend.Models.Notification", b =>
                {
                    b.HasOne("RCM.Backend.Models.Account", "ReceiverAccount")
