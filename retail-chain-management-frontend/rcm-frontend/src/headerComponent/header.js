            ...
            <div className="flex items-center justify-between p-4 bg-blue-600">
                ...
                <div className="flex items-center space-x-4">
                    <div 
                        ...
                        onMouseLeave={closeDropdown}
                    >
                        <button onClick={toggleBranchDropdown} className="text-white">Chi nhánh trung tâm</button>
                        {branchDropdown && (
                            <div className="absolute bg-white shadow-md rounded p-2">
                                <Link to="/branch1" className="block px-4 py-2 hover:bg-gray-200">Chi nhánh 1</Link>
                                <Link to="/branch2" className="block px-4 py-2 hover:bg-gray-200">Chi nhánh 2</Link>
                                <Link to="/branch3" className="block px-4 py-2 hover:bg-gray-200">Chi nhánh 3</Link>
                            </div>
                        )}
                    </div>
